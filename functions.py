...
def model_charts_goals(df):
  ...
  return fig1, r2_1, mae_1

def model_charts_residual(df):
  # PREDICTED GOALS
  out_chart = df[(df['keep'] == '1')]
...
def model_charts_points(df):
  ...
  ax3.set_xlabel('Predicted Points Difference')
